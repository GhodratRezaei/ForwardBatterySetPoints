...
const required = ["AZDO_TOKEN", "AZDO_COLLECTION", "AZDO_PROJECT", "CI_RUN_ID", "CI_PIPELINE_ID", "CI_COMMIT"];
...
if (build.status !== "completed" || build.result !== "succeeded" ||
    build.sourceBranch !== "refs/heads/main" || build.sourceVersion !== process.env.CI_COMMIT ||
